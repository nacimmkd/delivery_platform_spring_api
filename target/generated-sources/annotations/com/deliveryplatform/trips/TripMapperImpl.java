...
public class TripMapperImpl implements TripMapper {
    ...
    public TripResponse toResponse(Trip trip) {
        ...
        UUID userId = null;
        UUID id = null;
        GeocodedAddress departure = null;
        GeocodedAddress arrival = null;
    ...
    public Trip toEntity(TripRequest request) {
        ...
        trip.departure( addressToGeocodedAddress( request.departure() ) );
        trip.arrival( addressToGeocodedAddress( request.arrival() ) );
    ...
    public void updateEntity(Trip trip, TripRequest request) {
        ...
        if ( request.departure() != null ) {
            if ( trip.getDeparture() == null ) {
                trip.setDeparture( GeocodedAddress.builder().build() );
            }
            addressToGeocodedAddress1( request.departure(), trip.getDeparture() );
        }
        else {
        ...
        if ( request.arrival() != null ) {
            if ( trip.getArrival() == null ) {
                trip.setArrival( GeocodedAddress.builder().build() );
            }
            addressToGeocodedAddress1( request.arrival(), trip.getArrival() );
        }
        else {
